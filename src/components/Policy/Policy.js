...
const Policy = () => {
  return (
    <Wrapper className='section-center'>
      <h2>Privacy Policy for Foody</h2>
      <p>
        <br />
        At Foody, accessible from foody.com, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Foody and how we use it.{' '}
        <br /> <br />
        If you have additional questions or require more information about our
        Privacy Policy, do not hesitate to contact us. <br />
        This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they
        shared and/or collect in Foody. This policy is not applicable to any
      ...
      <p>
        <b>Log Files</b>
        <br /> <br />
        Foody follows a standard procedure of using log files. These files log
        ...
        advertising partners of Foody. <br /> <br />
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Foody, which are sent directly
        ...
        content that you see on websites that you visit. <br /> <br />
        **Note that Foody has no access to or control over these cookies that
        are used by third-party advertisers. <br /> <br />
        <b>Third Party Privacy Policies</b>
        <br /> <br />
        Foody's Privacy Policy does not apply to other advertisers or websites.
        ...
        a business has collected. <br />
        Request that a business that sells a consumer's personal data, not sell
        the consumer's personal data. <br />
        ...
        <br /> <br />
        Foody does not knowingly collect any Personal Identifiable Information
